            ...
            <div class="row justify-content-center">
                <div class="col-12 col-md-6">
                    <div class="login-content">
                        ...
                        <form action="/asm2/forgetpass" method="post">
                            <div class="form-group">
                                <input name="email" type="email" class="form-control" id="exampleInputEmail1" placeholder="Email or User Name">
                            </div>
                            <button type="submit" class="btn vizew-btn w-100 mt-30">Lấy Lại Mật Khẩu</button>
                        </form>
                        <a href="/asm2/signin" class="btn vizew-btn w-100 mt-30">Đăng Nhập</a>
