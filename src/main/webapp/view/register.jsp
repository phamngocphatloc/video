...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" href="<c:url value="/view/img/core-img/favicon.ico" /> ">
                ...
                <div class="col-12 col-md-6">
                    <div class="login-content">
                        ...
                        <div class="section-heading">
                            <h4>Rất Vui Vì Bạn Quan Tâm!</h4>
                            <div class="line"></div>
                        </div>

                        <form action="/asm2/signup" method="post">
                        	<div class="form-group">
                                <input name="fullname" type="text" class="form-control" id="exampleInputEmail1" placeholder="Họ Và Tên">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <input name="returnPassword" type="password" class="form-control" id="exampleInputPassword1" placeholder="Nhập Lại Mật Khẩu">
                            </div>
                            <div class="form-group">
                        ...
                        <a href="/asm2/signin" class="btn vizew-btn w-100 mt-30">Đã Có Tài Khoản</a>
